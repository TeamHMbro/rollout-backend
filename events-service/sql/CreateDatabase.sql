CREATE ROLE event_user WITH LOGIN PASSWORD 'CHANGE_ME_EVENT_PASSWORD';
...
CREATE INDEX ix_events_city_status_start_at
...
CREATE INDEX ix_event_members_user_status
